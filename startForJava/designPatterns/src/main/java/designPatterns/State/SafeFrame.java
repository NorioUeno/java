...
public class SafeFrame extends Frame implements Context, ActionListener {
  ...
  public void callSecurityCenter(String msg) {
    textScreen.append("call!" + msg + System.getProperty("line.separator"));
  }

  @Override
  public void recordLog(String masg) {
    textScreen.append("record..." + masg + System.getProperty("line.separator"));
  }
